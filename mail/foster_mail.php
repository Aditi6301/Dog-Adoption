...
if($getEmail->rowCount()>0)  //email found
{
   ...
   $email_subject = "Fostering Details:";
   $email_body = "Thank you, $first_name $last_name for showing interest in fostering $pupName\n\n"."You may contact on the details given below for fostering this furball:\n\nName: $firstName\n\nEmail: $Email\n\nPhone: $mobile\n\n";
